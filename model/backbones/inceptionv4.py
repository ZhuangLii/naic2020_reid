...
class Reduction_A(nn.Module):
    ...
    def __init__(self):
        ...
        self.branch0 = BasicConv2d(384, 384, kernel_size=3, stride=1)

        self.branch1 = nn.Sequential(
            BasicConv2d(384, 192, kernel_size=1, stride=1),
            BasicConv2d(192, 224, kernel_size=3, stride=1, padding=1),
            BasicConv2d(224, 256, kernel_size=3, stride=1)
        )

        self.branch2 = nn.MaxPool2d(3, stride=1)
...
class Inception_B(nn.Module):
    ...
    def __init__(self):
        ...
        self.branch2 = nn.Sequential(
            ...
            BasicConv2d(192, 224, kernel_size=(
                1, 7), stride=1, padding=(0, 3)),
            BasicConv2d(224, 224, kernel_size=(
                7, 1), stride=1, padding=(3, 0)),
...
class Reduction_B(nn.Module):
    ...
    def __init__(self):
        ...
        self.branch0 = nn.Sequential(
            BasicConv2d(1024, 192, kernel_size=1, stride=1),
            BasicConv2d(192, 192, kernel_size=3, stride=1)
        )

        self.branch1 = nn.Sequential(
            BasicConv2d(1024, 256, kernel_size=1, stride=1),
            BasicConv2d(256, 256, kernel_size=(
                1, 7), stride=1, padding=(0, 3)),
            BasicConv2d(256, 320, kernel_size=(
                7, 1), stride=1, padding=(3, 0)),
            BasicConv2d(320, 320, kernel_size=3, stride=1)
        )
...
def inception(num_classes=1000, pretrained='imagenet'):
    if pretrained:
        print('pretrained')
