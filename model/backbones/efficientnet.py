...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        self.last_conv = Conv2d(out_channels, out_channels, kernel_size=1, bias=False)
    ...
    def extract_features(self, inputs):
        ...
        """
        # Stem
        x = self._relu(self._bn0(self._conv_stem(inputs)))
        ...
        # Head
        x = self._relu2(self._bn1(self._conv_head(x)))
        return x
