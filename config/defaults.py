...
# if train with layer normalization
_C.MODEL.LAYERN0RM = True
...
_C.INPUT.PADDING = 10
_C.INPUT.RANDOM_PATCH_AREA = 0.1667
...
_C.DATASETS.HARD_AUG = 'ori_simple'
_C.DATASETS.EXCHANEL = True
_C.DATASETS.MIXUP = False
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
_C.SOLVER.T_MAX = 5
_C.SOLVER.ETA_MIN = 0.0002
_C.SOLVER.SWA = False
_C.SOLVER.SWA_START = [50]
...
# K1, K2, LAMBDA
_C.TEST.RE_RANKING_PARAMETER_GREEN = [20, 6, 0.3]
_C.TEST.RE_RANKING_PARAMETER_NORMAL = [20, 6, 0.3]
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
